...
DATA_DIR = Path(__file__).parent / "1-2_csv"
...
def main():
    ...
    plt.close(fig)
    print(f"saved {CHARTS_DIR / 'oks_1_2_errbar.png'} (+.svg)")
    ...
    plt.close(fig)
    print(f"saved {CHARTS_DIR / 'oks_1_2_shoulder_wrist_vs_distance.png'} (+.svg)")
    ...
    plt.close(fig)
    print(f"saved {CHARTS_DIR / 'oks_1_2_shoulder_wrist_vs_npeople.png'} (+.svg)")
